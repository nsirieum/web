...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-right">
            <span class="welcome-text">Hi, <?php echo $username; ?></span>
    ...
    <div class = "All-showing">
        <?php while($cc_all_row = mysqli_fetch_array($cc_all_result)){  ?>
            ...
            <div class="card">
                ...
                <img src="../img/<?php echo $cc_all_row['image'];?>" onerror="this.onerror=null; this.src='../img/default.jpg';" >

                <h1><?php echo $cc_all_row['cc_name']; ?></h1>
             

                <a href= "show_detail.php?cc_id=<?php echo $cc_all_row['cc_id']; ?>" class="btn-" > Buy Now </a>
            </div>
        <?php };?>
    </div>
    <br>
...
<style>
   ...
   .header-container {
    display: flex;
    justify-content: space-between; /* กระจาย 3 ส่วนออกจากกัน */
    align-items: center; /* จัดให้อยู่ระนาบเดียวกันในแนวตั้ง */
    padding: 15px 30px;
