...
<body>
    <div class="ticket-card">
        ...
        <div class="ticket-body">
            ...
            <div style="display: flex; justify-content: space-between;">
                <div class="info-group">
                    ...
                    <span class="value"><?php echo $orders_row['Artist']; ?></span>
                </div>
                <div class="info-group" style="text-align: right;">
                    <span class="label">Qty</span>
                    <span class="value"><?php echo $orders_row['qty']; ?></span>
                </div>
            </div>

            <div class="info-group">
                <span class="label">Show Date</span>
                <span class="value"><?php echo $orders_row['show_date']; ?></span>
            </div>
            ...
            <div class="info-group">
                ...
                <span class="value"><?php echo $orders_row['owner']; ?></span>
            </div>

            <div class="info-group">
                <span class="label">Purchaser Time</span>
                <span class="value"><?php echo $orders_row['order_date']; ?></span>
            </div>
        ...
        <div class="ticket-footer">
            <p class="barcode"><?php echo $orders_row['order_id']; ?></p>
            <p class="order-id"><?php echo $orders_row['order_id']; ?></p>
