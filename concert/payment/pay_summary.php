...
//ดึง database 
    // concert
$cc_id_sql = "SELECT* FROM concert_list WHERE cc_id='$cc_id' ";
$cc_id_result = mysqli_query($conn,$cc_id_sql);
$cc_id_row = mysqli_fetch_assoc($cc_id_result);

    // users
$u_sql = "SELECT* FROM users WHERE user_id='$user_id'";
...
<div class="summary-container">
    ...
    <div class="detail-row">
        ...
        <span class="value"><?php echo $cc_id_row['cc_name']; ?></span>
    </div>

    <div class="detail-row">
        <span class="label">Artist :</span>
        <span class="value"><?php echo $cc_id_row['Artist']; ?></span>
    </div>

    <div class="detail-row">
        <span class="label">Event Date : </span>
        <span class="value"><?php echo $cc_id_row['show_date']; ?></span>
    </div>
        ...
        <span class="value">
            <?php 
                if(isset($u_row['firstname']) && isset($u_row['lastname'])){
                    echo $u_row['firstname'].' '. $u_row['lastname'];    
    ...
    <form action="pay_summary.php" method="POST">
        ...
        <input type="hidden" name="ticket_qty" value="<?php echo $qty; ?>">

        <div class="payment-grid">
            <label class="pay-card">
                <input type="radio" name="payment_method" value="credit" <?php if($selected_payment == 'credit') echo 'checked'; ?> onchange="this.form.submit()">
