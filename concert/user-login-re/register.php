...
if($_SERVER["REQUEST_METHOD"]== "POST"){
    ...
    // แก้ Insecure data storage
    // $hash_pass = password_hash($pass, PASSWORD_DEFAULT); 
    // $hash_recheck_pass = password_hash($recheck_pass, PASSWORD_DEFAULT);
    ...
    if($recheck_pass != $pass){
        ...
        $u_sql = "INSERT INTO `users`(`email`, `firstname`, `lastname`, `username`, `password`) VALUES ('$email','$fname','$lname','$user','$pass')";
    ...
    // if($hash_pass != $hash_recheck_pass){
    //     echo "<script> alert('Passwords do not match!') ; window.history.back(); </script> ";
    // }elseif(strlen($recheck_pass) < 8){
    //     echo "<script> alert('Password must be at least 8 characters long!'); window.history.back(); </script> ";
    // }else{

    //     $u_sql = "INSERT INTO `users`(`email`, `firstname`, `lastname`, `username`, `password`) VALUES ('$email','$fname','$lname','$user','$hash_recheck_pass')";
